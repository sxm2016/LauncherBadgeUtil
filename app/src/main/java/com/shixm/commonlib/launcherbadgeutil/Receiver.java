...
public class Receiver extends BroadcastReceiver {
    ...
    public static final String ENTER_ACTION = "com.shixm.commonlib.launchbadger.ENTER_ACTION";
    public static final String DELETE_ACTION = "com.shixm.commonlib.launchbadger.deleteIntent";
